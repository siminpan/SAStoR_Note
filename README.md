...
|WEEKDAY(SAS-date)|format(as.Date(SAS-date, origin="1960-01-01"),"%w")|extracts the day of the week from a SAS date and returns a number from 1 to 7, where 1 represents Sunday, and so on.|
